...
const dbQuery = {
    ...
    GET_ACTIVE_INVENTORIES_LIST_QUERY: (category, current_status_active, is_deleted_no) => `select * From dbo.Inventory Where Category='${category}' And CurrentStatus='${current_status_active}' And IsDeleted=${is_deleted_no}`,
    ...
    GET_LASTINFO_QUERY: (inventoryid, is_deleted_no) => `select * From dbo.LocoCarRouteMapping Where InventoryID=${inventoryid} And IsDeleted=${is_deleted_no} `,
